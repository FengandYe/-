...
public class ClientExceptionConstant {
    ...
    public static final String ADNINISTRATOR_PASSWORD_INVALID_ERRCODE = "0100";
    public static final String ADNINISTRATOR_PASSWORD_INVALID_ERRMSG = "administrator password invalid errmsg";
